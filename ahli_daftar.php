...
if (isset($_POST["submit"])){
    ...
    if ($result == true)
        ...
        <div class='ok'>Pendaftaran ke aktiviti berjaya! </div>";
    else
...
<main>
    <h3 class="panjang">DAFTARKAN DIRI KE AKTIVITI</h3>
            ...
            <tr>
                ...
                <td>
                    <select name="idaktiviti">
                        <?php // Memaparkan aktiviti-aktiviti yang belum didaftar oleh ahli
